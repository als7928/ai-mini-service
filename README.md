...
![Architecture](assets/graph_image.png)
...
```bash
uv run app.py --topic "HBM4/PIM/CXL 경쟁사 분석"
```

## Contributors

- **안민혁** : LangGraph 워크플로우 구현, 에이전트 개발, PDF 파싱, 웹 검색
- **고길훈** : RAG 파이프라인 구현, 벡터 스토어 구성, 에이전트 개발, 프롬프트 설계